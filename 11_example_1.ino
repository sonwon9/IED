...
#define _DIST_ALPHA 0.6 // EMA weight of new sample (range: 0 to 1). Setting this value to 1 effectively disables EMA filter.

#define _DUTY_MIN 553 // servo full clockwise position (0 degree)
#define _DUTY_NEU 1476 // servo neutral position (90 degree) 1471~1481
...
if(dist_raw < 180.0) {
    ...
    myservo.writeMicroseconds(float_map(dist_ema, 180.0, 360.0,_DUTY_MIN,_DUTY_MAX));
